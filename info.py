...
BOT_TOKEN = environ.get('BOT_TOKEN', "5404511298:AAEa6mLk9En2j3DZkFVEf-H7TS0YgJRhyrU")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TG_Movies_Request_Group')
...
# Delete Time
DELETE_TIME = int(environ.get('DELETE_TIME', 3000000000))
SPL_DELETE_TIME = int(environ.get('SPL_DELETE_TIME', 15000000))
