...
BOT_TOKEN = environ.get('BOT_TOKEN', "5404511298:AAEKiTmErTqTPc6xxADq81CnvXOld-E0MtI")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001780651238').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TG_Updates_206')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/how_to_open_link204')
...
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/how_to_open_link204/2')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Powered By TG UPDATES Join ✓ https://t.me/TG_Updates_204")
...
# Delete Time
DELETE_TIME = int(environ.get('DELETE_TIME', 30000000000))
SPL_DELETE_TIME = int(environ.get('SPL_DELETE_TIME', 45000000))
